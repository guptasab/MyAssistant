...
@skill(
    ...
    params={"key": {"type": "string", "description": "The key to look up"}},
)
...
@skill(
    ...
    params={"key": {"type": "string", "description": "The key to delete"}},
)
...
@skill(
    ...
    params={"category": {"type": "string", "description": "Optional filter: preference|date|person|place|work|health|general"}},
)
...
@skill(
    ...
    params={"user_id": {"type": "string", "description": "User session ID"}},
)
...
@skill(
    ...
    params={"user_id": {"type": "string", "description": "User session ID to clear"}},
    sensitive=True,
)
