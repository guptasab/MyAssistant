"""Hugging Face skills exposed to the Ram agent.
...
def hf_suggest_models() -> str:
    ...
    from ram.skills.hf.manager import detect_hardware, suggest_models
    hw = detect_hardware()
...
def hf_list_catalog(category: str = "all", recommended_only: bool = False) -> str:
    ...
    from ram.skills.hf.catalog import ALL_MODELS, recommended
...
def hf_download_model(repo_id: str, dry_run: bool = False) -> str:
    ...
    from ram.skills.hf.catalog import get as catalog_get
    ...
    from ram.skills.hf.manager import download_model
    messages = []
...
def hf_list_installed() -> str:
    ...
    from ram.skills.hf.manager import list_installed
...
def hf_remove_model(repo_id: str, dry_run: bool = False) -> str:
    ...
    from ram.skills.hf.manager import remove_model
...
def hf_ask_local(prompt: str, repo_id: str = "") -> str:
    ...
    from ram.skills.hf.manager import list_installed, run_model
...
def hf_hardware_check() -> str:
    ...
    from ram.skills.hf.manager import detect_hardware
    hw = detect_hardware()
    tier_names = {
