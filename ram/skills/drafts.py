...
Ram studies your sent emails to learn your personal writing style, then
...
This is what separates Ram from generic AI — your emails sound like *you*.
"""
...
def _load_style_profile() -> dict:
    ...
    try:
        from ram.core.vector_memory import query as vmem_query
...
def _save_style_profile(profile: dict) -> None:
    ...
    try:
        from ram.core.vector_memory import upsert as vmem_upsert
