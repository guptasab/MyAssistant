"""Windows system tray channel for MyAssistant.
...
Usage:
  python -m myassistant --channel tray
"""
...
class Toast:
    ...
    def __init__(self, message: str, duration: float = 4.0) -> None:
        ...
        tk.Label(frame, text="🐏 MyAssistant", font=("Segoe UI", 10, "bold"),
...
class ChatWindow:
    ...
    def __init__(self, send_fn: Callable[[str], None]) -> None:
        ...
        self.root.title("MyAssistant — Personal Assistant")
    ...
    def _build_ui(self) -> None:
        ...
        hdr.pack(fill=tk.X)
        tk.Label(hdr, text="🐏 MyAssistant  •  Personal Assistant",
        ...
        self.chat_area.tag_config("assistant",  foreground=self.RAM_COLOR)
    ...
    def _quick(self, cmd: str) -> None:
        if cmd == "__open_settings__":
            ...
            webbrowser.open(f"http://localhost:{cfg.myassistant_http_port}/admin")
            return
    ...
    def append_message(self, sender: str, text: str, tag: str = "assistant") -> None:
    ...
    def reply_received(self, text: str) -> None:
        self.append_message("MyAssistant", text, "assistant")
...
class TrayChannel:
    ...
    def _setup_tray(self) -> None:
        ...
        try:
            ...
            menu = pystray.Menu(
                ...
                pystray.MenuItem("Quit MyAssistant", on_quit),
            )
            icon = pystray.Icon("MyAssistant", img, "MyAssistant — Personal Assistant", menu)
    ...
    def run(self) -> None:
        ...
        # Welcome message
        self._chat.append_message("MyAssistant",
            "👋 Hi! I'm MyAssistant, your personal assistant. "
            "Ask me anything — I can help with your schedule, tasks, finances, "
            "emails, code, and much more. Type or click a quick-action below.", "assistant")
