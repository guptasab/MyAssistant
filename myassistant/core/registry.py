...
it to the agent. Drop new skills in myassistant/skills/ and they're auto-discovered.
"""
...
def discover(package: str = "myassistant.skills") -> None:
    """Auto-import every module in myassistant.skills/ (recursive) so @skill decorators fire."""
    import pkgutil
