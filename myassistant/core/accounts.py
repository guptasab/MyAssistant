...
Every email/calendar account in MyAssistant is represented as an ``Account`` row in
...
Usage::
    ...
    from myassistant.core.accounts import list_accounts, get_account, add_account
...
def _encrypt(data: dict) -> str:
    ...
    raw = json.dumps(data)
    try:
        from myassistant.core.vault import _fernet
        f = _fernet()
        if f:
