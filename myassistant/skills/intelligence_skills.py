"""Intelligence skills — agent-callable wrappers for myassistant.core.intelligence.
...
def intelligence_report() -> str:
    ...
    from myassistant.core.intelligence import proactive_intelligence_report
...
def scan_follow_ups_skill(days_no_reply: int = 4) -> str:
    ...
    from myassistant.core.intelligence import scan_follow_ups
...
def meeting_brief_skill(event_title: str, attendees: list = None) -> str:
    ...
    from myassistant.core.intelligence import build_meeting_brief
...
def extract_action_items_skill(text: str, sender: str = "", subject: str = "") -> str:
    ...
    from myassistant.core.intelligence import extract_action_items_from_email
