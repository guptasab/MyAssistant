"""Curated Hugging Face model catalog for MyAssistant.

This module contains hand-curated, expert-vetted model recommendations
across all categories MyAssistant needs: chat/LLM, speech, embeddings, vision,
...
EMBED_MODELS: list[HFModel] = [
    HFModel(
        ...
        description=(
            ...
            "Runs on CPU with no GPU needed. Perfect for MyAssistant's semantic recall."
        ),
        tags=["embed", "private"],
        recommended=True,
...
STT_MODELS: list[HFModel] = [
    HFModel(
        ...
        tags=["private"],
        recommended=True,
        notes="Enable with MYASSISTANT_LOCAL_WHISPER=true in your .env",
    ),
    HFModel(
...
VISION_MODELS: list[HFModel] = [
    HFModel(
        ...
        description=(
            ...
            "Powers receipt scanning, document reading, and photo analysis in MyAssistant."
        ),
        tags=["vision", "private"],
        recommended=True,
    ),
