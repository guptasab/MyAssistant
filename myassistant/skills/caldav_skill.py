...
Accounts are registered in ``myassistant.core.accounts`` with kind="caldav" and
...
from myassistant.core.accounts import list_accounts, get_account_secret
...
def caldav_create_event(title: str, start: str, end: str = "",
    ...
    try:
        ...
        cal.add("prodid", "-//MyAssistant//caldav_skill//EN")
        cal.add("version", "2.0")
